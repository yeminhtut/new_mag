<?php 
	...
	$warrior_set_content  = '<h3 style="font-size:35px;margin-bottom:20px;line-height:40px;">Make that trip happen</h3>';
			...
			if ( $posts_tab_1->have_posts() ) :
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_categories_1).'" class="tab-content row post-wrapper">';
					...
					if ( has_post_thumbnail() ) {
						...
						$warrior_set_content .= '<div class="post-category"><a href="/category/destinations/asia/east-asia/south-korea">SOUTH KOREA</a></div>';
