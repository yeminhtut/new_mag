...
<style type="text/css">
body{color:#343434;}
article.hentry.slider-post .thumbnail { min-height: 200px;}
ul.tab-nav li{width: 33.3333%;text-align: center;}
ul.tab-nav{margin-bottom: 20px;}
ul.tab-nav li a{ border-right: 1px solid #EAE6E6 !important;}
ul.tab-nav {border-bottom: 1px solid #DEDADA !important;}
article.hentry.slider-post .entry-content{position: relative;}
#about-author .detail p{margin-bottom: 18px;}
#about-author .detail p a{color:#c51818;}
#mainslider{margin-bottom: 60px;}
#logo{max-width: 320px;padding-bottom: 40px;padding-top:40px;}
#map-canvas {width: 100%;min-height: 385px;background-color: #ddd;cursor: pointer;}
#section3 img{height: 160px !important;}
#block-line{width: 100%;height: 1px;background: red;margin: 20px 0px;}
#single-post article .entry-content a{ color: #ff6600; text-decoration: underline;}
.post-list-style ul li{padding-right: 20px;}
.entry-content .alignnone img{width: 100%}
.copyright{ font-family: Lato;font-size: 14px; font-weight: 400;letter-spacing: 1px;text-transform: uppercase;font-size: 12px;}
.social{padding-top: 10px !important;}
.category-interest a{margin-bottom: 20px !important;}
.entry-content img{display: block;}
.owl-carousel .owl-item img{height: 240px;}
.homepage-widget .section-title h4{text-transform: capitalize;}
.airline_logo{margin-left:4px;height:18px !important;margin-bottom:-4px}.airport_tooltip{display:inline;position:relative}
.airport_tooltip:hover:after{color:#c7254e;background-color:#f9f2f4;border-color:#d6e9c6;border-radius:0;bottom:22px;content:attr(title);left:20%;padding:2px 4px;position:absolute;z-index:98;text-align:center;width:180px}
.airport_tooltip:hover:before{border:solid;border-color:#f9f2f4 transparent;border-width:6px 6px 0;bottom:16px;content:"";left:22%;position:absolute;z-index:99}
.fz_roundtrip .template-inline{text-decoration:none;color:#c7254e;background-color:#f9f2f4;padding:4px 6px;font-size:12px;font-weight:600}
.fz_roundtrip .template-inline:hover{background:#FFF;color:#1683b1}
.fz_roundtrip img{display: inline-block;}
.entry-content img{width:100%;}
.airline_logo{width: auto !important;}
.related-post img{height: 150px;}
.related-post a{color:#000 !important;text-decoration: none !important;}
.pagination-holder .prev{float:left;}
.owl-dot {opacity: 0.2;}
#maincontent {padding-top: 20px;}
#scroll-top{bottom:50px;}
#archive-page article.hentry.full-width-post.left-thumbnail h3.post-title{-webkit-line-clamp: 4;}
@media only screen and (min-width:960px) and (max-width:1080px){
	nav#main-menu.site-navigation{max-width: 624px;}
	#logo{max-width: 220px;}
	nav#main-menu.site-navigation ul li a {padding: 8px;font-size: 12px;}
}
@media screen and (max-width: 780px){    
    article.hentry.full-width-post.left-thumbnail { margin-bottom: 20px;}
    .footer-widgets .column, #footer-widgets .column { margin-bottom: 0px;}
    .author-box{margin-bottom: 20px;}
    .homepage-widget {margin-bottom: 10px;}
    .related-post img {height: auto;} 
    .article-widget{margin-bottom: 20px;}
    .pagination{margin: 30px 0 30px 0;}  
    #recent-mini-row .column{height: 80px;}
    #mainslider{margin-bottom: 20px;}
    #footer-widgets .inner img{max-height: 200px;}
    #maincontent{padding-top: 20px;} 
    #primary, #secondary-content{margin-bottom: 20px;} 
    article.hentry.slider-post .entry-content h3 { margin-bottom: 0px;}       
}
...
nav#main-menu.site-navigation{float:none !important;}
